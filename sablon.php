  ...
  <form class="form-inline">
		...
		<table class="table" width='80%' border=0>
			...
			while ($res = mysqli_fetch_array($result)) {
				...
				echo "<td><a href=\"edit.php?id=$res[id]\"><a href=\"edit.php?id=$res[id]\">Edit</a> | <a href=\"delete_sablon.php?id=$res[id]\" onClick=\"return confirm('Kamu yakin untuk delete ini?')\">Delete</a></td>";
			}
			?>
		</table>
	</center>
